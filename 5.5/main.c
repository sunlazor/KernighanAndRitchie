...
* библиотечных функций strncpy, strncat и strncmp,
* которые обрабатывают не более чем п первых
* символов своих строковых аргументов. Например,
* функция strncpy (s, t,n) копирует не более п
* символов из строки t в строку s.
*
*/
